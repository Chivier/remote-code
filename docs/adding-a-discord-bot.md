...
This guide walks you through creating a Discord Application, configuring the bot, and wiring it into Remote Claude.
...
3. Give it a name (e.g. `Remote Claude`) and click **Create**.
...
## Step 6: Configure Remote Claude
